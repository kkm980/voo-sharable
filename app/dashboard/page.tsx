...
export default function Home() {
  ...
  const supportingLangs = useAppSelector((state: any) => state.counterReducer.supportingLangs);
  const loading = useAppSelector((state: any) => state.counterReducer.loading);
  const multiLangInputListStore = useAppSelector((state: any) => state.counterReducer.multiLangInputListStore);
